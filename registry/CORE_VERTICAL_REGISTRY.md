...
This file is the authoritative registry of engines (vertical work engines) recognized by CORE.
Anything not listed here is not a valid CORE engine.
...
- governance review
- engine governance file present
- registry update committed with audit trace

If an engine is not in this registry, CORE must refuse to run it.
